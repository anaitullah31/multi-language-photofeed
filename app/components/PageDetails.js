...
const PageDetails = async ({ id, lang }) => {
  ...
  return (
    <div className="grid grid-cols-12 gap-4 2xl:gap-10 mt-7">
      <div className="col-span-12 lg:col-span-8">
        <Image
          className="max-w-full w-full object-cover rounded-xl h-full max-h-[70vh] mx-auto"
          src={photo.url}
          alt={photo.title}
          width={900}
          height={500}
        ...
        <div className="mt-6">
          <div className="flex justify-between items-center mb-3">
            ...
            <button className="flex items-center gap-1.5 text-black/60 text-xs xl:text-sm">
              <Image alt="follow" src="/follow.svg" height={50} width={50} className="w-5 h-5" />
              {dictionary.follow}
            </button>
          </div>
